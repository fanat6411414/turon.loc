...
class Menu extends \common\models\base\SMenu
{
    public $nameUz;
    public $nameRu;
    public $nameEn;
    ...
    public function getParent(int $id=null)
    {
        if($id){
            return self::findOne($id);
        }
        return ArrayHelper::map(self::findAll(['status' => Pages::STATUS_ACTIVE]), 'id', 'name');
    }
