...
<div class="book-index card card-body">
    ...
    <div class="row">
        ...
        <div class="col-md-8">
            <p class="text-right">
                <?= Html::a('<i class="fa fa-plus-circle"></i>', ['/fakultet/add'], ['class' => 'btn btn-sm btn-success']) ?>
                <?= Html::submitButton('<i class="fa fa-search"></i>', ['class' => 'btn btn-sm btn-primary']) ?>
                <?= Html::a('<i class="fa fa-filter"></i>', ['/fakultet/index'], ['class' => 'btn btn-sm btn-default']) ?>
            </p>
        </div>
    </div>
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                'attribute' => 'name',
                'value' => function ($model){ return Html::a($model->name, ['/fakultet/add', 'id' => $model->alias]); },
                'format' => 'raw'
            ],
            [
                ...
                'buttons' => [
                    'translate' => function ($url, $model) {
                        return Html::a('<i class="fa fa-language"></i>', ['/fakultet/translate', 'id' => $model->alias],
                            ['class' => 'btn btn-sm btn-primary', 'style' => 'margin-left: 5px']);
                    },
                    'delete' => function ($url, $model) {
                        return Html::a(
                            '<i class="fa fa-trash"></i>', ['/fakultet/delete', 'id' => $model->alias], [
