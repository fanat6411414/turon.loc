...
<div class="book-index card card-body">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <p class="text-right">
                <?= Html::a('<i class="fa fa-plus-circle"></i>', ['/qabul/edu-add'], ['class' => 'btn btn-sm btn-success']) ?>
                <?= Html::submitButton('<i class="fa fa-search"></i>', ['class' => 'btn btn-sm btn-primary']) ?>
                <?= Html::a('<i class="fa fa-filter"></i>', ['/qabul/edu-list'], ['class' => 'btn btn-sm btn-default']) ?>
            </p>
        </div>
    </div>
        ...
        'columns' => [
            ...
            [
                ...
                'value' => function ($model){
                    return Html::a($model->name.'<p class="small text-black-50 m-0">'.$model->desc.'</p>', [
                        '/qabul/edu-add', 'id' => $model->alias
                    ]); },
                'format' => 'raw'
            ],
            [
            ...
            [
                ...
                'buttons' => [
                    'translate' => function ($url, $model) {
                        return Html::a('<i class="fa fa-language"></i>', ['/qabul/edu-translate', 'id' => $model->alias],
                            ['class' => 'btn btn-sm btn-primary', 'style' => 'margin-left: 5px']);
                    },
                    'delete' => function ($url, $model) {
                        return Html::a(
                            '<i class="fa fa-trash"></i>', ['/qabul/edu-delete', 'id' => $model->alias], [
