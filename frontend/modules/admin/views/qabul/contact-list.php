    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <p class="text-right">
                ...
                <?= Html::a('<i class="fa fa-filter"></i>', ['/qabul/ariza-list'], ['class' => 'btn btn-sm btn-default']) ?>
            </p>
        </div>
    </div>
            ...
            [
                ...
                'value' => function ($model){
                    return Html::a('<p class="small text-black-50 m-0">'.$model->title.'</p>'.$model->name, [
                        '/qabul/ariza-add', 'id' => $model->alias
                    ]); },
                'format' => 'raw'
            ],
            [
            ...
            [
                ...
                'buttons' => [
                    'translate' => function ($url, $model) {
                        return Html::a('<i class="fa fa-language"></i>', ['/qabul/ariza-translate', 'id' => $model->alias],
                            ['class' => 'btn btn-sm btn-primary', 'style' => 'margin-left: 5px']);
                    },
                    'delete' => function ($url, $model) {
                        return Html::a(
                            '<i class="fa fa-trash"></i>', ['/qabul/ariza-delete', 'id' => $model->alias], [
