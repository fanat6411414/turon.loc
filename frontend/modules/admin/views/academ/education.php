                    ...
                    'columns' => [
                        ...
                        [
                            ...
                            'value' => function ($data) use ($model) {
                                return Html::a($data->name, ['education', 'id' => $data->id], []);
                            }
                        ],
                    ],
                ]); ?>
        ...
        <div class="card card-outline card-success">
            ...
            <div class="card-footer text-right">
                <?php if (!$model->isNewRecord): ?>
                    <?= Html::a('Cancel', ['education'], ['class' => 'btn btn-sm btn-default btn-flat']) ?>
                    <?= Html::a('Delete', ['education', 'id' => $model->id, 'delete' => 1], ['class' => 'btn btn-sm btn-danger btn-flat btn-delete', 'data-pjax' => 0]) ?>
                <?php else: ?>
                <?php endif; ?>
